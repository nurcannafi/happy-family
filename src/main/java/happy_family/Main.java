...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        controller.getFamilyById(0).addChild(new Human("Alice", "Doe", 2010));
        controller.getFamilyById(0).addChild(new Human("Bob", "Doe", 2012));
        controller.getFamilyById(1).addChild(new Human("Chris", "Smith", 2015));
